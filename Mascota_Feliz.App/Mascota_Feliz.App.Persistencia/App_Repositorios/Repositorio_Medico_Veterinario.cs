...
namespace Mascota_Feliz.App.Persistencia.App_Repositorios
{
    public class Repositorio_Medico_Veterinario : IRepositorio_Medico_Veterinario
    {
        ...
        void IRepositorio_Medico_Veterinario.DeleteMedico_Veterinario(int ID_Veterinario)
        {
            var medico_veterinarioEncontrado = _appContext.veterinarios.FirstOrDefault(v => v.id == medico_veterinario.ID_Veterinario;
        ...
        Medico_Veterinario IRepositorio_Medico_Veterinario.GetMedico_Veterinario(int ID_Veterinario)
        {
            return _appContext.veterinarios.FirstOrDefault(v => v.id == medico_veterinario.ID_Veterinario);
        }
        ...
        Medico_Veterinario IRepositorio_Medico_Veterinario.UpdateMedico_Veterinario(Medico_Veterinario medico_veterinario)
        {
            ...
            if (medico_veterinarioEncontrado != null)
            {
                medico_veterinario.ID_Veterinario = medico_veterinarioEncontrado.id;
